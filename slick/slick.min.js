  ...
  Slick = (function () {
    ...
    function Slick(element, settings) {
      ...
      _.defaults = {
        ...
        asNavFor: null,
        prevArrow:
          '<button class="slick-prev" aria-label="Previous" type="button"><i class="fa fa-arrow-left" aria-hidden="true"></i></button>',
        nextArrow:
          '<button class="slick-next" aria-label="Next" type="button"><i class="fa fa-arrow-right" aria-hidden="true"></i></button>',
        autoplay: false,
        autoplaySpeed: 3e3,
        centerMode: false,
        centerPadding: "50px",
